        ...
        <section id="hero" className="flex flex-col items-center justify-center px-4 relative min-h-screen">
            <div className="container max-w-4xl mx-auto text-center z-10 relative">
                ...
                <p className="text-sm text-pretty px-6 md:text-lg md:px-10 max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3 mb-4">
                    ...
                    <img src={sacral} alt="sacral chakra" className="chakira-icon absolute w-12 h-12 -bottom-[28%] left-[14%] md:w-20 md:h-20 md:-bottom-[89%] md:left-[14%] lg:w-25 lg:h-25 transform pulse-slow opacity-0" />
                    ...
                    <img src={blocked} alt="third eye chakra" className="chakira-icon absolute w-12 h-10 -top-[35%] left-[15%] md:w-20 md:h-16 md:-top-[80%] md:left-[15%] lg:w-24 lg:h-20 transform pulse-slow opacity-0" />
                    <img src={root} alt="root chakra" className="chakira-icon absolute w-10 h-10 -bottom-[25%] right-[16%] md:w-20 md:h-20 md:-bottom-[85%] md:right-[16%] lg:w-21 lg:h-21 transform pulse-slow opacity-0" />
                    ...
                    <img src={blue} alt="blue chakra" className="chakira-icon absolute w-10 h-10 -top-[35%] right-[15%] md:w-20 md:h-20 md:-top-[85%] md:right-[15%] lg:w-24 lg:h-24 transform pulse-slow opacity-0" />
                    <img src={purple} alt="crown chakra" className="chakira-icon absolute w-10 h-10 -top-[50%] translate-x-1/2 right-[50%] md:w-20 md:h-20 md:-top-[100%] md:translate-x-1/2 md:right-[50%] lg:w-24 lg:h-24 transform pulse-slow opacity-0" />
